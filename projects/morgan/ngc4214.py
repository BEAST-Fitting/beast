...
project = 'mf_ngc4214_full_new'
obsfile = 'ngc4214/data/N4214_3band_detects.fits'
...
#---------------------------------------------------------
data_mapping = {'F225W_VEGA': 'HST_WFC3_F225W',
                'F225W_ERR': 'HST_WFC3_F225Werr',
...
if __name__ == '__main__':
    ...
    #fit_phat = Pipeline('fit', tasks_fit)
