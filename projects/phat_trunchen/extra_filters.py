# code to create extra filters for specific interesting integrations
...
def make_integration_filter(startlam, endlam, dlamb, name,
    ...
    _name = '{obs:s}_{inst:s}_{name:s}'.format(obs=observatory,
...
def test():
    f = make_integration_filter(90., 913., 1, 'QION', observatory='SUDO',
                                instrument='Fake')
    return f
