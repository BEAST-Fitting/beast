...
def _test_create_physicsmodel_no_subgrid():
    ...
    shutil.copy2(
        "/astro/dust_kg3/lhagen/stsci/beast-examples_lea-hagen/testing/datamodel_no_subgrid.py",
        "./datamodel.py",
    )
...
def test_create_physicsmodel_with_subgrid():
    ...
    # os.rename(datamodel_fname, "datamodel.py")
    shutil.copy2(
        "/astro/dust_kg3/lhagen/stsci/beast-examples_lea-hagen/testing/datamodel_with_subgrid.py",
        "./datamodel.py",
    )
    # - input files (referenced in datamodel)
    filter_fname = download_rename("filters.hd5")
    ...
    priors_sub0_fname_cache = (
        prefix + "beast_example_phat_subgrids_spec_w_priors.gridsub0.hd5"
    )
    priors_sub1_fname_cache = (
        prefix + "beast_example_phat_subgrids_spec_w_priors.gridsub1.hd5"
    )
    # - anticipated output files
