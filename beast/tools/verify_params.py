...
def verify_input_format(datamodel):
	...
	parameters = [datamodel.z, datamodel.obsfile, \
	              datamodel.astfile, datamodel.logt, datamodel.avs, datamodel.rvs, datamodel.fAs, datamodel.trackVersion]
	parameters_names = ['z', 'obsfile', 'astfile', 'logt', 'avs', 'rvs', 'fAs', 'trackVersion']
