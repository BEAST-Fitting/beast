#!/usr/bin/env python
"""
Script to run the BEAST on the SMC SMIDGE data.
Karl G. - 3 Dec 2015
...
if __name__ == '__main__':
    ...
    if args.noise:
        ...
        noisemodel.make_splinter_noise_model(datamodel.noisefile, modelsedgrid, absflux_a_matrix=datamodel.absflux_a_matrix)  
