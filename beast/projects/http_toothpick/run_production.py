#!/usr/bin/env python
"""
Code to run the BEAST on the HTTP data in production mode.
...
Updated for LMC/HTTP by Karl G. 23 Sep 2015
...
# BEAST imports
from pipeline_production import make_models
...
if __name__ == '__main__':
    ...
    parser.add_argument("sub_source_density", help="subset of the source density bin [0, 1, 2, ...]")
    ...
    datamodel.noisefile = 'HTTP_production/HTTP_production_noisemodel.fits'

    #datamodel.noisefile = 'HTTP_production/HTTP_production_sd_' + \
    ...
    modelsedgrid_filename = 'HTTP_production/HTTP_production_seds.grid.hd5'
    ...
    if args.models:
        datamodel.project = 'HTTP_production'
        make_models()
