...
if __name__ == '__main__':
    ...
    # HTTP filter names
    #filter_names = ['HST_WFC3_F275W', 'HST_WFC3_F336W', 'HST_ACS_WFC_F555W',
    #           'HST_WFC3_F658N', 'HST_ACS_WFC_F775W', 'HST_WFC3_F775W',
    #           'HST_WFC3_F110W', 'HST_WFC3_F160W']

    filter_names = ['HST_WFC3_F275W', 'HST_WFC3_F336W', 'HST_ACS_WFC_F555W',
                    'HST_ACS_WFC_F775W', 'HST_WFC3_F775W',
                    'HST_WFC3_F110W', 'HST_WFC3_F160W']
    out_names = ['F275W','F336W','F555W','F775W','F775W','F110W','F160W']
