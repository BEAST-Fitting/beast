...
#from beast.physicsmodel.prior_weights_dust import set_av_weights
...
def test_dust_prior_weights():
    ...
    np.testing.assert_allclose(prior_weights.av_priors,np.full((len(av_vals)), 1.0))
    ...
    np.testing.assert_allclose(prior_weights.av_priors, expected_lognormal_av)
    ...
    np.testing.assert_allclose(prior_weights.av_priors, expected_two_lognormal_av)
    ...
    np.testing.assert_allclose(prior_weights.av_priors, expected_exponential_av)
    ...
    np.testing.assert_allclose(prior_weights.rv_priors, expected_lognormal_rv)
    ...
    np.testing.assert_allclose(prior_weights.rv_priors, expected_two_lognormal_rv)
    ...
    np.testing.assert_allclose(prior_weights.fA_priors, expected_lognormal_fA)
    ...
    np.testing.assert_allclose(prior_weights.fA_priors, expected_two_lognormal_fA)
