...
from beast_lh.observationmodel.ast.make_ast_input_list import (pick_models,
...
def run_beast_production(basename,
    ...
    modelsedgrid_filename = "%s/%s_seds.grid.hd5"%(datamodel.project,
                                                   datamodel.project)
    #modelsedgrid_filename = "PHAT_seds.grid.hd5"
    ...
    if ast:
        ...
        # the previous AST method (randomly selected SEDs)
        ...
        # the new AST method (SEDs in flux bins)
        outfile = './' + datamodel.project + '/' + datamodel.project + '_inputAST.txt'
        outfile_params = './' + datamodel.project + '/' + datamodel.project + '_ASTparams.fits'
        ...
        chosen_seds = pick_models_toothpick_style(modelsedgrid_filename, datamodel.filters,
                                  ...
                                  outfile=outfile, outfile_params=outfile_params, bins_outfile=bins_outfile)
