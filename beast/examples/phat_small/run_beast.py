    ...
    if args.ast:
        ...
        if datamodel.ast_with_positions == True:
            ...
            if datamodel.ast_source_density_table is not None:
                pick_positions_from_map(chosen_seds, datamodel.ast_source_density_table, datamodel.ast_N_bins, datamodel.ast_realization_per_model, outfile=filename, refimage=datamodel.ast_reference_image, Nrealize=1)

            if datamodel.ast_background_table is not None:
                pick_positions_from_map(chosen_seds, datamodel.ast_background_table, datamodel.ast_N_bins, datamodel.ast_realization_per_model, outfile=filename, refimage=datamodel.ast_reference_image, Nrealize=1)
