...
"""
try:
    from .c_likelihood import c_N_chi2 as N_chi2
    ...
    import warnings
    warnings.warn('C-code cannot be imported, did you run make? Using python code instead')
    from .likelihood import N_chi2
